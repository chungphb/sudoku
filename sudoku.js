...
function allowed(A, y, x) {
    var i; 		// Mang luu tru danh sach cac gia tri hop le cua A[y][x].
    var res = [];	// Mang boolean danh dau cac gia tri v ma phep gan A[y][x] = v co the dan den vi pham cac rang buoc cua bai toan Sudoku.
